    ...
    <div className="service">
        ...
        <div className="serviceframe">
            ...
            <div className="question">
                    <button onClick={() => q1 == true ? setq1(false) : setq1(true) } className="questiontittle">Redenen waarom de anti diefstal bout verwijderd moet worden:{ q1 == true ?<img width={20} src="Up.png" alt="" /> : <img width={20} src="Down.png" alt="" />   }</button>
                ...
                <div className="question">
                    <button onClick={() => q2 == true ? setq2(false) : setq2(true) } className="questiontittle">Eigenschappen van anti diefstal bouten die het moeilijker maken ze los te krijgen { q2 == true ?<img width={20} src="Up.png" alt="" /> : <img width={20} src="Down.png" alt="" />   } </button>
                ...
                <div className="question">
                    <button onClick={() => q3 == true ? setq3(false) : setq3(true) } className="questiontittle">Anti diefstal bouten losmaken { q3 == true ?<img width={20} src="Up.png" alt="" /> : <img width={20} src="Down.png" alt="" />   } </button>
                ...
                <div className="question">
                    <button onClick={() => q4 == true ? setq4(false) : setq4(true) } className="questiontittle">SLOTBOUT LOSMAKEN OPTIE B: Veiligheidsbouten uitgerust zijn met vrijloop ring:{ q4 == true ?<img width={20} src="Up.png" alt="" /> : <img width={20} src="Down.png" alt="" />   } </button>
                ...
                <div className="question">
                    <button onClick={() => q5 == true ? setq5(false) : setq5(true) } className="questiontittle">SLOTBOUT UITBOREN OPTIE C: { q5 == true ?<img width={20} src="Up.png" alt="" /> : <img width={20} src="Down.png" alt="" />   } </button>
